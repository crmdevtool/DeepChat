...
public class SettingActivity extends AppCompatActivity {
    ...
    private Button mchangeImage,mchangeStatus,buttonChangeNome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonChangeNome=(Button)findViewById(R.id.buttonChangeNome);
   ...
   public void buttonIsClicked(View view){
       ...
       switch(view.getId()){
           ...
           //------CHANGING NOME DE PERFIL------
           case R.id.buttonChangeNome:
               Intent intent1 =new Intent(SettingActivity.this,NomeActivity.class);
               intent1.putExtra("current_name",name);
