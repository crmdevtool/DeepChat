...
//imports de dependencias do firebase
...
//        Log.e("user_id is",user_id);
        ...
        mFriendDatabase=FirebaseDatabase.getInstance().getReference().child("amigos");
        mNotificationReference=FirebaseDatabase.getInstance().getReference().child("notificações");
        ...
        mProgressDialog.setTitle("Buscando Detalhes");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mFriendDatabase.child(user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mprofileFriendCount.setText("TOTAL AMIGOS : "+len);
                        ...
                        mfriendReqReference.child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(dataSnapshot.hasChild(user_id)){
                                    ...
                                    if(request_type.equals("sent")){
                                        ...
                                        mProfileSendReqButton.setText("Cancelar pedido de amizade");
                                        mProfileDeclineReqButton.setVisibility(View.INVISIBLE);
                                        mProfileDeclineReqButton.setEnabled(false);
                                        ...
                                        mProfileSendReqButton.setText("Aceitar solicitação de amizade");
                                    ...
                                    mFriendDatabase.child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                            ...
                                            if(dataSnapshot.hasChild(user_id)){
                                                ...
                                                mProfileSendReqButton.setText("Desfazer amizade");
                                            }
                                            mProgressDialog.dismiss();
                                        }
                            ...
                            @Override
                            public void onCancelled(DatabaseError databaseError) {
                                Toast.makeText(ProfileActivity.this, "Erro ao buscar os dados da solicitação do amigo!", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        mProfileSendReqButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUserId.equals(user_id)){
                    Toast.makeText(ProfileActivity.this, "Não é possível enviar uma solicitação para você!", Toast.LENGTH_SHORT).show();
                    return ;
                }
                ...
                if(mCurrent_state.equals("not_friends")){
                    ...
                    DatabaseReference newNotificationReference = mRootReference.child("notificações").child(user_id).push();
                    ...
                    requestMap.put("notificações/"+user_id+"/"+newNotificationId,notificationData);
                    ...
                    mRootReference.updateChildren(requestMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError==null){
                                ...
                                Toast.makeText(ProfileActivity.this, "Pedido de amizade enviado com sucesso!", Toast.LENGTH_SHORT).show();
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivity.this, "Algum erro aconteceu no envio de solicitação de amizade!", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivity.this, "Pedido de amizade cancelado com sucesso!", Toast.LENGTH_SHORT).show();
                            }
                            else{

                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivity.this, "Não é possível cancelar o pedido de amizade!", Toast.LENGTH_SHORT).show();
                    ...
                    mRootReference.updateChildren(friendMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            ...
                            if(databaseError==null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivity.this, "Erro é " +databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                ...
                if(mCurrent_state.equals("amigos")){
                    ...
                    Map valueMap=new HashMap();
                    valueMap.put("amigos/"+mFirebaseUser.getUid()+"/"+user_id,null);
                    valueMap.put("amigos/"+user_id+"/"+mFirebaseUser.getUid(),null);
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setText("Send Friend Request");
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivity.this, "Amizade desfeita com sucesso!", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivity.this, "Não é possível desfazer amizade! Entre em contato com suporte do Deep Chat.", Toast.LENGTH_SHORT).show();
                ...
                mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if(databaseError == null){
                            ...
                            mCurrent_state = "not_friends";
                            mProfileSendReqButton.setText("Enviar solicitação de amizade");
                            mProfileSendReqButton.setEnabled(true);
                            Toast.makeText(ProfileActivity.this, "Pedido de amizade recusado com sucesso...", Toast.LENGTH_SHORT).show();
                            ...
                            mProfileSendReqButton.setEnabled(true);
                            Toast.makeText(ProfileActivity.this, "Não é possível recusar o pedido de amizade...", Toast.LENGTH_SHORT).show();
