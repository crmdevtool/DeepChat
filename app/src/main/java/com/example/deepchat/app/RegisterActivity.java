...
public class RegisterActivity extends AppCompatActivity {
    ...
    Button buttonsubmit, buttonRegistrado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonRegistrado=(Button)findViewById(R.id.buttonRegistrado);
    ...
    public void buttonIsClicked(View view){
        ...
        if(view.getId()==R.id.button3){
            ...
            if(displayname.equals("")){
                Toast.makeText(RegisterActivity.this, "Por favor, preencha o nome", Toast.LENGTH_SHORT).show();
                return;
            }

            if(email.equals("")){
                Toast.makeText(RegisterActivity.this, "Por favor, preencha o email", Toast.LENGTH_SHORT).show();
                return ;
            }

            if(password.length()<6){
                Toast.makeText(RegisterActivity.this, "A senha é muito curta", Toast.LENGTH_SHORT).show();
                return;
            }

            progressDialog.setTitle("Registrando usuário");
            progressDialog.setMessage("Por favor aguarde enquanto criamos sua conta... ");
        ...
        mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this,new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    userMap.put("status","Olá! Estou usando Deep Chat");
                    ...
                    mDatabase.child(uid).setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task1) {
                            if(task1.isSuccessful()){
                                ...
                                Toast.makeText(RegisterActivity.this, "SEU NOME NÃO ESTÁ REGISTRADO... FAZER NOVA CONTA-- ", Toast.LENGTH_SHORT).show();
                ...
                //---ERROR IN ACCOUNT CREATING OF NEW USER---
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(getApplicationContext(), "ERROR USUÁRIO REGISTRADO....", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
